...
exports.config = {
	...
	specs 	: [
		'./tests/functional/specs/**/*.feature'
	] ,
	...
	cucumberOpts 	: {
		...
		tags 		: require ( './tests/functional/configuration/tags' ) , // <string[]> (expression) only execute the features or scenarios with tags matching the expression
